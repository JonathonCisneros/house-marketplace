...
Why use Zillow or Redfin when you can use our House Marketplace App and pay $0 fees? Place your home on sale with use or search for your next home! This app allows users to create an account via email or Google Authentication and create listings to sell or rent homes. Project created during [Brady Traversy's](https://www.traversymedia.com/) React Front to Back 2022 course on [Udemy](https://www.udemy.com/course/react-front-to-back-2022/).
